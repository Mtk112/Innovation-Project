...
/*This file is just a copy of the DefaultTrackableEventHandler.cs. The purpose of this is to save the modifications
 * incase Vuforia needs to be updated, which would reset the DefaultTrackableEventHandler.cs back to its original state.*/
